...
const Submit=async(e)=>{
  e.preventDefault()
  try {
    await axios.post("http://localhost:8000",{name})
  }
   catch (e) {
    console.log(e,"error occured here");
...
//   e.preventDefault()
//    const postURL = "https://localhost:3000/" //Our previously set up route in the backend
//   fetch(postURL, {
//       method: 'POST',
//       headers: { 
...
// }
  ...
  return (
    <div className={css.formcontain}> 
      ...
      <form  action="POST" className={css.contactForm} >
